/*
 * Title: Main.java
 * Description: Implements a dynamic hash table using linear probing for collision
 *              resolution. Supports insert, delete, search, dynamic resizing
 *              (based on load factor), and status display operations.
 * Author: Shane Skare
 * Date: 05/02/2024
 * References:
